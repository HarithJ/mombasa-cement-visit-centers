...
for(const version of ['v1','v2','v3']){
  ...
  html=html.replace('Your name, phone number and visit details are stored to record your visit. No email or message is sent.','Design preview only. Use sample details. Nothing entered here is submitted or saved.');
