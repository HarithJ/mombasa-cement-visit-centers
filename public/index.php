...
$mapLinks = require __DIR__.'/../config/locations.php';
$routeIllustrations = require __DIR__.'/../config/route-illustrations.php';
$destinations = [
