            ...
            <div id="form-view" <?= $confirmation ? 'hidden' : '' ?>>
                ...
                <form id="booking-form" method="post" action="<?= e($bookingPath) ?>" novalidate>
                    ...
                    <div class="form-grid">
                        ...
                        <?php foreach ($destinations as $id => $destination): ?><span hidden data-location-meta="<?= e($id) ?>" data-map-url="<?= e($mapLinks[$id]) ?>" data-map-embed="<?= e($mapEmbeds[$id]) ?>" data-name="<?= e($destination['name']) ?>"></span><?php endforeach; ?>
