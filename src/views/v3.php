...
<head>
    ...
    <link rel="stylesheet" href="/assets/versions/v3/travel.css">
    ...
    <script src="/assets/versions/v3/app.js" defer></script>
</head>
<body>
        ...
        <div class="destinations wrap" id="destinations" aria-label="Choose a destination">
            ...
            <article class="destination" id="place-<?= e($id) ?>" data-destination="<?= e($id) ?>">
                ...
                <div class="destination-info">
                    ...
                    <a class="book-button" data-book="<?= e($id) ?>" href="<?= e($bookingPath) ?>?book=<?= e($id) ?>">Let’s plan a visit <?= icon('diagonal') ?></a>
                </div>
            </article>
            <?php endforeach; ?>
        </div>
...
<dialog id="booking-dialog" aria-labelledby="<?= $confirmation ? 'confirmation-title' : 'booking-title' ?>" <?= $openForm || $confirmation ? 'open' : '' ?>>
    <div class="dialog-toolbar"><span class="itinerary-label">YOUR NEXT ADVENTURE <span>/ VISIT NYUMBA</span></span><a role="button" href="<?= e($bookingPath) ?>" class="close-button" aria-label="Close booking form"><?= icon('close') ?></a></div>
