        ...
        <div class="booking-main">
            <div id="form-view" <?= $confirmation ? 'hidden' : '' ?>>
                ...
                <form id="booking-form" method="post" action="<?= e($bookingPath) ?>" novalidate>
                    ...
                    <p class="privacy-note">Your name, phone number and visit details are stored to record your visit and may be emailed to the destination team to coordinate your visit.</p>
